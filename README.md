...
4. Вам <span style="text-decoration: underline">нужно получить изменения из ветки</span> <b>master</b> в ветку <b>develop</b> и при этом не затереть изменения в ветке <b>develop</b>.
