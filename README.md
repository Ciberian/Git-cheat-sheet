...
------------------------------------------------------------------------------------------------------------------------------
#### Отдельно нужно отметить работу с rebase
------------------------------------------------------------------------------------------------------------------------------
1. Допустим мы создали ветку **develop** из ветки **master**.
2. Поработали в ветке **develop** и сделали несколько коммитов.
3. Тем временем кто-то также поработал в ветки **master** и внёс туда изменения и закоммитил.
4. <span style="text-decoration: underline">Вам нужно притащить изменения из ветки <b>master</b> в ветку <b>develop</b> и при этом не затереть изменения в ветке <b>develop</b></span>.
5. Встаём в ветку <b>develop</b> и вызываем команду `git rebase master` - теперь измениния из ветки **master** попали в ветку **develop**
