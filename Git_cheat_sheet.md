...
`.` - путь, обозначающий текущию директорию, т.е. ту в которой запущена команда.
`:/` - путь, обозначающий рабочую директорию, т.е. ту в которой находится директория .git
Используя `:/` можно индексировать файлы рабочей директории, находять при этом в во вложенных директориях.
...
При этом данная команда не затрагивате модифицированные или проиндексированные файлы.
...
[Еще вариант .gitignore-a](https://github.com/Hexlet/hexlet-cv/blob/main/.gitignore)
